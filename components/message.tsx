...
import { GiftProgress } from '@/components/gift';
      ...
      >
        ...
        >
          {message.role === 'assistant' && (
            ...
            <div className="size-8 items-center rounded-full justify-center ring-1 shrink-0 ring-border bg-background hidden">
